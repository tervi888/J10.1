...
public class RadioTest {
    ...
    @Test
    public void shouldPreviousVolume1() {
        Radio radio = new Radio();
        radio.setCurrentVolume(100);
        radio.turnDownVolume();
        int expected = 99;
    ...
    @Test
    public void shouldPreviousVolume2() {
        Radio radio = new Radio();
        radio.setCurrentVolume(0);
        radio.turnDownVolume();
        int expected = 0;
    ...
    @Test
    public void shouldPreviousVolume4() {
        Radio radio = new Radio();
